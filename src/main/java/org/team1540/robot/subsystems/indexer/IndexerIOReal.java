...
public class IndexerIOReal implements IndexerIO {
    private final TalonFX spinFalcon = new TalonFX(IndexerConstants.SPIN_MOTOR_ID);
    private final VoltageOut spinVoltageRequest = new VoltageOut(0);
    private final StatusSignal<AngularVelocity> spinVelocityRPS = spinFalcon.getVelocity();
    private final StatusSignal<Voltage> spinMotorAppliedVolts = spinFalcon.getMotorVoltage();
    ...
    public IndexerIOReal() {
        ...
        spinTalonFXConfig.Feedback.SensorToMechanismRatio = IndexerConstants.SPIN_GEAR_RATIO;
